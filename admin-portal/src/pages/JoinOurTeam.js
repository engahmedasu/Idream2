...
import { FiUsers, FiSearch, FiEye, FiTrash2, FiX, FiFilter, FiDownload } from 'react-icons/fi';
...
const JoinOurTeam = () => {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const response = await api.get('/requests/stats', { params: { type: 'join-our-team' } });
    ...
    <div className="requests-page">
      <div className="requests-header">
        <div className="requests-title-section">
          <FiUsers className="requests-icon" />
          <h1>Join Our Team Requests</h1>
        </div>
                ...
                {requests.map((request) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>{request.email}</td>
                      <td>{request.positionOfInterest || 'N/A'}</td>
                      <td>
        ...
        <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Join Our Team Request Details</h2>
            ...
            <div className="modal-body">
              ...
              <div className="detail-row">
                ...
                <span>{selectedRequest.positionOfInterest || 'N/A'}</span>
              </div>
              <div className="detail-row">
                <label>Cover Letter:</label>
                <div className="message-content">{selectedRequest.coverLetter || 'N/A'}</div>
              </div>
              <div className="detail-row">
                <label>Status:</label>
