...
import { FiZap, FiSearch, FiEye, FiTrash2, FiX, FiFilter, FiDownload } from 'react-icons/fi';
...
const NewIdeas = () => {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const response = await api.get('/requests/stats', { params: { type: 'new-ideas' } });
    ...
    <div className="requests-page">
      <div className="requests-header">
        <div className="requests-title-section">
          <FiZap className="requests-icon" />
          <h1>New Ideas Requests</h1>
        </div>
      ...
      <div className="requests-filters">
        <div className="search-box">
          ...
          <input
            type="text"
            placeholder="Search by name, email, idea title..."
            value={searchTerm}
            onChange={(e) => {
        ...
        <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>New Ideas Request Details</h2>
            ...
            <div className="modal-body">
              ...
              <div className="detail-row">
                ...
                <span>{selectedRequest.ideaTitle || 'N/A'}</span>
              </div>
              <div className="detail-row">
                <label>Brief Idea Description:</label>
                <div className="message-content">{selectedRequest.briefIdeaDescription || 'N/A'}</div>
              </div>
              <div className="detail-row">
                <label>Status:</label>
